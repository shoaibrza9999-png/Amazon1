document.addEventListener('DOMContentLoaded', () => {
        ...
        if (!profileSection.classList.contains('hidden')) {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    document.getElementById('profile-email-notif').checked = data.email_notifications;
                    document.getElementById('profile-telegram-notif').checked = data.telegram_notifications;
                }
            } catch (err) {
                console.error(err);
            }
    ...
    document.getElementById('profile-form').addEventListener('submit', async (e) => {
        ...
        const email_notifications = document.getElementById('profile-email-notif').checked;
        const telegram_notifications = document.getElementById('profile-telegram-notif').checked;
        const msgDiv = document.getElementById('profile-msg');
        msgDiv.textContent = 'Updating...';

        const payload = { email, telegram_chat_id, scraper_api_keys, email_notifications, telegram_notifications };
